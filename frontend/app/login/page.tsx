...
export default function LoginPage() {
  ...
  return (
    <main className="quest-login">
      <style dangerouslySetInnerHTML={{ __html: LOGIN_CSS }} />

      <section className="quest-shell" aria-labelledby="login-heading">
        <img
        ...
        <div className="parchment-frame">
          <div className="parchment-panel">
            <h1 id="login-heading" className="quest-title">
              Welcome Back!
            </h1>
            <p className="quest-subtitle">Log in to continue your math journey.</p>
            ...
            <form onSubmit={handleSubmit} className="quest-form">
              <label className="quest-input-row" htmlFor="login-email">
              ...
              <label className="quest-input-row" htmlFor="login-password">
                <span className="quest-input-icon" aria-hidden="true">
              ...
              <div className="quest-button-wrap">
                <button id="login-submit" type="submit" disabled={loading} className="quest-button">
