  ...
  return (
    <>
      ...
      <group position={frame.position} rotation={[0, frame.rotation, 0]} scale={frame.scale}>
        ...
        <Landmark title="Tactics · Tangled Thorns" detail={`${errors.length} ${errors.length === 1 ? "error" : "errors"} logged · review your tangled steps`} position={sitePosition("thorns")} onClick={() => visit("thorns", "/error-history")} kind="thorns" selected={selectedSite === "thorns"} tooltipPortal={visible ? tooltipPortal : undefined} />
